...
export const PUBLIC_CONTENT = {
  es: {
    ...
    reservationForm: {
      ...
      phoneHint: "Indica un teléfono válido (solo dígitos, espacios y + - ( )).",
      email: "Email",
      seating: "Preferencia",
      terrace: "Terraza",
      inside: "Interior",
  ...
  en: {
    ...
    reservationForm: {
      ...
      phone: "Phone",
      phonePlaceholder: "+34 600 123 456",
      phoneHint: "Enter a valid phone (digits, spaces and + - ( ) only).",
      email: "Email",
      seating: "Preference",
      terrace: "Terrace",
      inside: "Inside",
  ...
  ca: {
    ...
    reservationForm: {
      ...
      phone: "Telèfon",
      phonePlaceholder: "+34 600 123 456",
      phoneHint: "Indica un telèfon vàlid (només dígits, espais i + - ( )).",
      email: "Correu",
      seating: "Preferència",
      terrace: "Terrassa",
      inside: "Interior",
